...
8. **Meal recommendation** → Call \`recommend_meal\` with cuisine and location; uses Google Maps (Geocoding + Places API Legacy) for real-world restaurant data. Set \`GOOGLE_MAPS_API_KEY\` in the environment.
