/**
 * `recommend_meal` tool registration.
 */
...
import { fetchWeatherByCoords, classifyWeather } from '../services/openweather';
 ...
 */
export function registerMealRecommendationTool(server: McpServer): void {
